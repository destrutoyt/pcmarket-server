...
(2, 4799.98),  -- 2 items (Gaming PC + Laptop)
(2, 1299.99),
(4, 3199.98),  -- 2 items (Gaming PC + Prebuilt)
(4, 2999.99),
(5, 2599.99),
(5, 2599.99),
(3, 5399.98),  -- 3 items in one order
(3, 3499.99),
(1, 3199.98),  -- 2 items
(1, 8399.97),  -- 3 items
(1, 2999.99),
...
-- Order 1 (buyer 2)
(1, 1, 1, 1, 3499.99, 'Delivered'),
(1, 4, 2, 1, 1299.99, 'Delivered'),

-- Order 2
(2, 5, 3, 1, 1299.99, 'Shipped'),

-- Order 3 (buyer 4)
(3, 2, 1, 1, 1899.99, 'Delivered'),
(3, 5, 3, 1, 1299.99, 'Canceled'),

-- Order 4
(4, 3, 2, 1, 2999.99, 'Shipped'),

-- Order 5
(5, 4, 2, 1, 2599.99, 'Delivered'),

-- Order 6
(6, 5, 3, 1, 2599.99, 'Processing'),

-- Order 7 (buyer 3)
(7, 1, 1, 1, 3499.99, 'Delivered'),
(7, 2, 1, 1, 1899.99, 'Canceled'),
(7, 5, 3, 1, 1299.99, 'Delivered'),

-- Order 8
(8, 1, 1, 1, 3499.99, 'Shipped'),

-- Order 9 (buyer 1)
(9, 5, 3, 1, 1299.99, 'Canceled'),
(9, 2, 1, 1, 1899.99, 'Delivered'),

-- Order 10 (buyer 1)
(10, 1, 1, 1, 3499.99, 'Delivered'),
(10, 2, 1, 1, 1899.99, 'Delivered'),
(10, 3, 2, 1, 2999.99, 'Delivered'),

-- Order 11
(11, 3, 2, 1, 2999.99, 'Shipped'),

-- Order 12
(12, 4, 2, 1, 2599.99, 'Processing'),

-- Order 13
(13, 3, 2, 1, 2999.99, 'Pending'),

-- Order 14
(14, 4, 2, 1, 2599.99, 'Processing'),

-- Order 15
(15, 1, 1, 1, 3499.99, 'Canceled'),
